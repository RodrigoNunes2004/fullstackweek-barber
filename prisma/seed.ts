 ...
 async function seedDatabase() {
   try {
    ...
    "Classic Style",
     ...
     const addresses = [
    "123 Street, Barbershop",
    "456 Avenue, Cuts",
    "789 Square, Beard",
    "101 Alley, Razor",
    "202 Boulevard, Styles",
    "303 Road, Axe",
    "404 Avenue, Elegant",
    "505 Square, Appearance",
    "606 Street, Urban",
    "707 Avenue, Classic",
     ];
     ...
     const services = [
        ...
        {
          name: "Beard",
          description: "Complete styling to enhance your masculinity.",
          price: 40.0,
        ...
        {
          name: "Eyebrows",
          description: "Accentuated expression with precise styling.",
          price: 20.0,
     ...
     // Criate 10 barbers with names and phisical addresses
     const barbershops = [];
     for (let i = 0; i < 10; i++) {
